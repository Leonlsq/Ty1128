...
const slides = [
  ...
  },
  {
    ...
    date: '2025.09.29',
    text: '以前的我，总觉得有些话太矫情，说不出口。直到那场突如其来的高烧，烧得我迷迷糊糊，却好像也把那个曾经的我也一并烧没了。躺在床上那一刻我突然明白，比起难堪或是出丑更可怕的，是来不及。于是深夜一点，我借着病后的‘冲动’，按下了那个迟到了几年的发送键。既然不想留遗憾，那就把真心话都告诉你。还好，那晚的勇气，换来了你的‘晚点回你’，也换来了我们的现在。',
    backgroundType: 'image', 
  ...
  },
  {
    ...
    text: '那时的我，别扭又忐忑，发完那一大段真心话就‘怂’了，特意补了一句‘别回我’。其实心里却在不自觉地期待。但好像，无论出于何种原因，你总是会回。或许这就是我们的缘分吧，要在一起的注定：我爱用‘别回我’来给自己留退路，而你用一句‘晚点回你’，堵住了我所有的胡思乱想，重新为我铺了一条走向你的路。\n你知道吗？看到你说‘没有对不起’，说那是一段‘纯真的画卷’时，我心里那块压了多年的石头终于落地了。谢谢你，没有听我的话；谢谢你，愿意接住那个笨拙的我，把我的‘遗憾’变成了我们共同的‘美好’。',
    backgroundType: 'image', 
  ...
  },
  {
    ...
    text: '但现实的剧情总有曲折。遇到的奇葩房东和搬家的一地鸡毛，让我在慕尼黑差点崩溃。\n\n那几天，我选择了‘消失’。不是不想找你，而是胆怯和纠结。我看着满屋的狼藉，心里只有一个念头：‘隔着几千公里，你凭什么要在乎如此狼狈的我？’ 我怕我的负能量会把你吓跑，所以一个人扛，选择一个人的寂静。\n\n那时候的我以为，爱是只分享光鲜。但其实爱，是敢于把那个破碎的、狼狈的自己也拼凑进来，让你拥有一个完整的我。\n\n 从此以后，笑的那个人是我，哭的那个人，同样也是我。',
    backgroundType: 'image',
...

{
  ...
  // ✨✨✨ 新增：FaceTime 视频分批展示页 ✨✨✨
  {
    ...
    gallery: [
      { img: '/photos/视频/1.5.png' ,text:'吃火锅的你' }, { img: '/photos/7.png' ,text:'眼睛起雾了' },
      { img: '/photos/视频/8.PNG',text:'在街上边走边打视频哦'  }, { img: '/photos/9.png',text:'快递派送中...' },
